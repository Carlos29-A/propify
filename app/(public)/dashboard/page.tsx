    ...
    return (
        <>
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 ">
                ...
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 flex items-center gap-2 shadow-lg transition-transform active:scale-95 cursor-pointer">
